...
router.post("/add", (req, res) => {
    ...
    const posted_by_id = req.body.posted_by_id;
    ...
    //query = "INSERT INTO job_listing VALUES (" + posted_by_id + ", '" + company_name + "', '" + job_location + "' , '" + job_title + "' , '" + job_description + "' , '" + job_experience + "' , " + salary + ", '" + image_url + "')";
